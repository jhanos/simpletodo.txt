...
class ReminderReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        // Daily alarm fired — find tasks due today and post notifications
    ...
    private fun postNotification(
        ...
        // Use a stable ID based on text hash so the same task doesn't get
        // duplicate notifications if the receiver fires more than once.
